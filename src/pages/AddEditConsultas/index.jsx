...
const AddEditConsultas = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!idconsultas) {
      ...
      firebaseDb.child(`/clientes/${id}/consultas`).push(state, (err) => {
        if (err) {
          toast.error(err);
        } else {
  ...
  return (
    <div className='add-edit'>
      <form className='add-edit__form' onSubmit={handleSubmit}>
        ...
        <input type='submit' value={idconsultas ? "Atualizar" : "Cadastrar"} />
      </form>
    </div>
  );
};

export default AddEditConsultas;
